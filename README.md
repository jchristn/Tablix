...
- **Watson 7 REST hosting:** the server uses Watson 7 built-in API routing and OpenAPI/Swagger support directly; the deprecated SwiftStack package is no longer required.
