namespace Tablix.Server
{
    ...
    public static class TablixChatToolDefinitions
    {
        ...
        private static Dictionary<string, object> BuildQueryProperty()
        {
            ...
            {
                { "type", "string" },
                { "description", "One SQL statement to execute. The statement type must be allowed by the selected database. Do not include semicolons or a trailing SQL terminator." }
            };
        }
