...
const tooltips: Record<string, string> = {
  ...
  'nav.tables': 'Browse tables for a selected database and generate table context.',
  ...
  'actions.details': 'Open detailed health and configuration status for this record.',
  ...
  'models.healthEnabled': 'Run lightweight background checks against this provider endpoint.',
  'models.healthAuth': 'Send the saved provider API key with health check requests.',
  'models.healthUrl': 'Absolute URL used by background health checks.',
  'models.healthMethod': 'HTTP method used by background health checks.',
  'models.healthInterval': 'Delay between background health checks.',
  'models.healthTimeout': 'Timeout for one background health check request.',
  'models.healthStatus': 'HTTP status code treated as a successful health check.',
  'models.healthyThreshold': 'Consecutive successful checks required to mark the provider healthy.',
  'models.unhealthyThreshold': 'Consecutive failed checks required to mark the provider unhealthy.',
